    ...
    <div className="max-w-3xl mx-auto">
      ...
      <div className="mb-8">
        <button
          ...
          className="flex items-center justify-center gap-2 w-full py-3 px-4 rounded-lg text-sm font-medium text-slate-400 hover:text-white hover:bg-[#162040] transition-all duration-200"
        >
          How it works
          {showHowItWorks ? <ChevronUp className="w-4 h-4" /> : <ChevronDown className="w-4 h-4" />}
        </button>
        {showHowItWorks && (
          <div className="flex flex-wrap items-center justify-center gap-4 py-5 px-5 rounded-xl bg-[#162040] border border-[rgba(56,189,248,0.1)] mt-2">
      ...
      <Card className="p-6 lg:p-8 shadow-[0_0_15px_rgba(56,189,248,0.04)] border-[rgba(56,189,248,0.1)]">
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
            ...
            <div className="flex flex-col sm:flex-row gap-6 p-4 rounded-lg bg-[#162040] border border-[rgba(56,189,248,0.1)]">
              <FormField
                control={form.control}
                name="quickMode"
                render={({ field }) => (
                        ...
                        <button
                          ...
                          className={`px-4 py-2 rounded-md text-sm font-medium border transition-colors duration-200 ${
                            goalValue === goal
                              ...
                              : "border-[rgba(56,189,248,0.1)] bg-[#111d35] text-slate-400 hover:border-[rgba(56,189,248,0.15)]"
                          }`}
            ...
            <Button
              ...
              className="w-full btn-primary-glow btn-gold text-white no-default-hover-elevate no-default-active-elevate"
      ...
      <div className="flex flex-wrap items-center justify-center gap-8 mt-8 pt-6 border-t border-[rgba(56,189,248,0.1)]">
