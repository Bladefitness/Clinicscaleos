...
export function PipelineView({
  ...
  return (
    <Card className="p-5 mb-6 overflow-hidden shadow-[0_0_15px_rgba(56,189,248,0.04)] border-[rgba(56,189,248,0.1)]">
      ...
      <div className="flex flex-col sm:flex-row sm:items-stretch gap-4 sm:gap-2 overflow-x-auto pb-2 sm:pb-0">
        ...
        <span className="hidden sm:inline text-slate-400 self-center flex-shrink-0">→</span>
